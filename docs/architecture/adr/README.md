...
Двадцать пятая запись стоит особняком: она заведена не по открытому вопросу
фазы 1, а по результату [фазы 5](../06-assessment.md) — сквозное допущение,
на которое молча опирались три решения, не принадлежало ни одному.
