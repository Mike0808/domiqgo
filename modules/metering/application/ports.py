...
class MeteringRepository(Protocol):
    ...
    def closed_periods(self, apartment_id: int) -> set: ...

    def close_period(self, apartment_id: int, period: date) -> bool: ...

    def reopen_period(self, apartment_id: int, period: date) -> bool: ...
